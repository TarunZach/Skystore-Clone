...
function Signup() {
    ...
    const handleSubmit = (e) => {
        ...
        if (title.value == 'Please select' || fname == null || lname == null || email == null || password == null) {
            ...
            if (!fnameError && !lnameError && !emailError && !cemailError && !passwordError && !cpasswordError) {
                const obj = {
                    fname,
                    lname,
                    email,
                ...
                if (document.getElementById('terms').checked && document.getElementById('conditions').checked) {
    ...
    return (
        <form className="inputFormWrapper">
                    ...
                    onBlur={(e) => {
                        ...
                        if (!!e.target.value) {
                            if ((e.target.value).match(/^[a-zA-Z\s, ]+$/)) {
                                setfnameError("");
                                document.getElementById('signupfname').style.border = "1px solid #abb6c5";
                ...
                <input
                    ...
                    onBlur={(e) => {
                        ...
                        if (!!e.target.value) {
                            if ((e.target.value).match(/^[a-zA-Z\s, ]+$/)) {
                                setlnameError("");
                                document.getElementById('signuplname').style.border = "1px solid #abb6c5";
            ...
            <div className="form-group">
                ...
                <input
                    ...
                    onChange={(e) => {
                        setCemail(e.target.value);
                        setcemailError('');
                        document.getElementById('cemail').style.border = "1px solid #abb6c5";
                    }}
                />
                {
            ...
            <div className="form-group">
                ...
                <input
                    ...
                    onBlur={(e) => {
                        ...
                        if (!!e.target.value) {
                            if ((e.target.value).match(/^((?=\S*?[A-Z])(?=\S*?[a-z])(?=\S*?[0-9]).{6,})\S$/)) {
                                setpasswordError("");
                                document.getElementById('password').style.border = "1px solid #abb6c5";
            ...
            <div className="form-group captcha">
                <img src="https://skyid.sky.com/captcha/jpeg?width=200&height=60&cachebuster=1653481476507" alt="captcha" height="60" width="200" />
            </div>
            ...
            <div className="form-group checkbox1" style={{
                marginTop: "0px"
            }}>
            ...
            <div className="buttonrow">
                <a href='#' className="supforgotSign forgotSign" onClick={() =>
                    history('/signin')
                }>Cancel</a>
                <button id="submitButton" className='signIn supsignIn' type='submit' onClick={handleSubmit}>Create Sky iD</button>
                <button id="cancelButtonMobile" className='signIn supCancel' type='button' onClick={() =>
                    history('/signin')
                }>Cancel</button>
            </div>
